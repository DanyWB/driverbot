...
return [
    ...
    'binding_rate_limit_per_minute' => (int) env('BOT_API_BINDING_RATE_LIMIT_PER_MINUTE', 10),
    'binding_revoke_service_rate_limit_per_minute' => (int) env('BOT_API_BINDING_REVOKE_SERVICE_RATE_LIMIT_PER_MINUTE', 120),
    'binding_revoke_rate_limit_per_minute' => (int) env('BOT_API_BINDING_REVOKE_RATE_LIMIT_PER_MINUTE', 30),
