...
- реалистичный коридор: 105-140 часов;
...
Проект рабочий локально: зависимости установлены, JS-синтаксис файлов проекта проходит проверку, локальная PostgreSQL-база доступна, все 20 миграций применены, pending-миграций нет.
