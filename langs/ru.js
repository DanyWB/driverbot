module.exports = {
  ...
  cmd_add_name: "✏️ Изменить имя",
  cmd_add_tel: "📞 Изменить номер",
  cmd_add_passport: "🪪 Загрузить паспорт",
  ...
  enter_passport: "🪪 Пожалуйста, отправьте фото паспорта:",

  update_name_prompt: "✏️ Введите новое имя:",
  update_tel_prompt:
    "📞 Введите новый номер телефона в международном формате (например, +79995551234):",
  update_passport_prompt: "🪪 Отправьте новое фото паспорта:",

  menu_title: "🏠 Главное меню:",
  menu_book: "📅 Забронировать байк",
  menu_rental: "🧾 Моя аренда",
  menu_update_name: "✏️ Изменить имя",
  menu_update_tel: "📞 Изменить номер",
  menu_update_passport: "🪪 Загрузить паспорт",
  ...
  passport_missing: "Пожалуйста, отправьте фото (не документ, не текст).",
  passport_save_error: "Не удалось сохранить фото. Попробуйте снова.",
  passport_saved: "Фото паспорта успешно сохранено.",
  ...
  booking_admin_new:
    "🚨 <b>Новая аренда</b>\n\nПользователь: {user} Telegram: @{username}\nБайк: <b>{bike}</b>\nСрок: {start} - {end}\nИтог: {price} THB\nКомментарий: {comment}",
