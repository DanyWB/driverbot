module.exports = {
  ...
  telegram_bind_usage:
    "Введіть код прив’язки з веб-адмінки у форматі: /bind КОД",
  telegram_bind_private_only:
    "З міркувань безпеки прив’язку можна виконати лише в особистому чаті з ботом.",
  telegram_bind_exposed_revocation_attempted:
    "⚠️ Цей код було оприлюднено поза особистим чатом. Не використовуйте його. Створіть новий код у веб-адмінці та перед продовженням перевірте, який акаунт зараз прив’язано.",
  telegram_bind_exposed_revocation_failed:
    "⚠️ Цей код було розкрито, але підтвердити його відкликання не вдалося. Негайно створіть новий код і перевірте або замініть поточну прив’язку у веб-адмінці.",
  telegram_bind_success:
    "✅ Telegram успішно прив’язано. Сповіщення адмінки надходитимуть у цей чат.",
  telegram_bind_invalid:
    "Код прив’язки недійсний або прострочений. Створіть новий код у веб-адмінці.",
  telegram_bind_already_bound:
    "Цей Telegram-акаунт уже прив’язаний до іншого адміністратора.",
  telegram_bind_admin_inactive:
    "Акаунт адміністратора недоступний для прив’язки. Увійдіть у веб-адмінку та створіть новий код.",
  telegram_bind_rate_limited:
    "Забагато спроб прив’язки. Зачекайте хвилину та спробуйте знову.",
  telegram_bind_unavailable:
    "Не вдалося прив’язати Telegram. Спробуйте ще раз трохи пізніше.",
