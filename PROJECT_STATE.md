...
Текущий статус реализации: этапы 0-7 roadmap закрыты. Созданы Laravel foundation,
...
финальную цену, управлять публикацией техники и открыть историю клиента. Legacy-бот
пока остается на старой БД до этапа Bot API. Следующий этап - защищенный Laravel Bot
API и поэтапный перевод Telegram-сценариев с прямых Knex-запросов.
