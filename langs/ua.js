module.exports = {
  ...
  enter_passport: "🪪 Будь ласка, надішліть фото паспорта:",

  update_name_prompt: "✏️ Введіть нове ім'я:",
  update_tel_prompt:
    "📞 Введіть новий номер телефону у міжнародному форматі (наприклад, +79995551234):",
  update_passport_prompt: "🪪 Надішліть нове фото паспорта:",
  ...
  passport_missing: "Будь ласка, надішліть фото (не документ, не текст).",
  passport_save_error: "Не вдалося зберегти фото. Спробуйте ще раз.",
  passport_saved: "Фото паспорта успішно збережено.",
